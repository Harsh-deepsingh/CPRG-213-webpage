...
let newduration = 0; // Initialize newduration variable
...
function recalculate() {
    let new_total_cost = document.getElementById("calculated-cost");
    let totalcost = 0;

    if (modelName.innerHTML === "Model XYZ") {
        totalcost = newduration * 100;
    } else if (modelName.innerHTML === "Model CPRG") {
        totalcost = newduration * 213;
    }

    new_total_cost.innerHTML = totalcost;
}
...
function changeDuration() {
    newduration = parseInt(prompt("Enter new duration below: "));
